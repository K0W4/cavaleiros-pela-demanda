...
export default function Enigma2() {
  const { answer, setAnswer, isUnlocked, errorCount, checkAnswer } = useEnigma('BEAUJEU')
    ...
    <div className="min-h-screen bg-templar-stone flex flex-col items-center pt-32 pb-20 px-6">
      <div className="max-w-2xl w-full flex flex-col gap-8 items-center">
        ...
        <div className="w-full border-l-2 border-templar-red bg-black/20 p-6 italic text-templar-parchment/70 text-center text-sm sm:text-base mt-4 shadow-inner">
          <p>Existem verdades que a olho nu não se descobre. Use suas próprias ferramentas para trazer a luz.</p>
        </div>

        <div className="w-full bg-black border border-templar-gold/5 p-2 sm:p-4 shadow-2xl relative flex items-center justify-center min-h-[200px] rounded-sm">
          <img 
            src="/enigma2.png" 
            alt="Um pergaminho envolto em sombras" 
            className="w-full h-auto object-contain drop-shadow-md select-none pointer-events-auto"
          />
        </div>
          ...
          <div className="w-full flex flex-col items-center gap-6 mt-8 animate-fade-in">
            <div className="text-templar-gold text-center space-y-2">
              ...
              <p className="font-body text-templar-parchment/80">
                A bravura de <strong>Beaujeu</strong> vive em vocês.
              </p>
            </div>
